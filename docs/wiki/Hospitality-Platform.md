...
Continue with the [Adiona migration](Adiona-Migration), which converts Adiona's source MySQL catalog/user schema to PostgreSQL 19 and implements operations in NoETL YAML using the Rust runtime. It preserves products and services beyond lodging.

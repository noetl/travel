...
[Contracts and run instructions](https://github.com/noetl/travel/blob/kadyapam/hospitality-reservations/adiona/docs/hospitality.md) explain request shapes, retry rules, credential boundaries and the distinction between confirmation and payment. All seven new playbooks are public in the repository. The schema preserves catalog products and services beyond lodging.
